...
#this logic can be modified based on the need from where you want to refer the source code.
...
#this logic can be modified based on the need from where you want to refer the semgrep output file
def main():
    sarif_file_path = '/Users/myname/Desktop/ai-code-review/xxx-xxx/output.sarif'
